...
const CouncilManager = () => {
  const { members: items, updateMembers, publishToGithub, isPublishing } = useData();
  ...
  const saveToStorage = async (newItems: CouncilMember[]) => {
    setSaving(true);
    try {
          ...
          <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-100 mb-10 animate-in fade-in slide-in-from-top-4 duration-300">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div>
                ...
                {editForm?.image && (
                  <div className="mt-4 relative w-20 h-20 rounded-full overflow-hidden border border-gray-200 mx-auto bg-gray-50">
